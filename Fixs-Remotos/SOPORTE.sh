...
wget -O /bin/rebootnb raw.github.com/lacasitamx/SCRIPT-LATAM/Netvps/Fixs-Remotos/rebootnb.sh &>/dev/null #oficial > https://www.dropbox.com/s/8thnqvw2ljvjelw/rebootnb.sh &>/dev/null
